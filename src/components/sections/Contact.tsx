          ...
          >
            ...
            <MagnetButton strength={5} className="w-full sm:w-auto">
              <Button
                ...
                variant="outline"
                size="lg"
                className="w-full sm:w-auto h-12 px-6 sm:px-8 transition-all duration-200 hover:scale-[1.02] hover:border-primary/50 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
              >
                <a
